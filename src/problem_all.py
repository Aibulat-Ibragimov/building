...
try:
    ...
    records = data['table_oks_with_problems'][0]['records']
    ...
    wb.save(f'C:\\Users\\Aibulat\\work\\building\\output\\oks_with_problems_{date_now}.xlsx')

    print(f'Данные успешно сохранены в файл oks_with_problems_{date_now}.xlsx')
